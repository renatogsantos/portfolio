          ...
          <div className="grid lg:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="font-medium text-main-700 dark:text-white">
                Pronto para iniciar sua jornada digital? Entre em contato
                conosco para uma consulta inicial. Estamos aqui para ouvir suas
                ideias, entender suas necessidades e transformar seus objetivos
